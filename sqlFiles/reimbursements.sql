...
CREATE TABLE ALLEMPLOYEES(
	...
	CONSTRAINT noDups UNIQUE (EMPLOYEEID,EMAIL)
);
...
CREATE OR REPLACE PROCEDURE create_request(REQUESTID OUT NUMBER, AMOUNT IN DECIMAL, PURPOSE IN varchar2, SUBMITTEDDATE IN varchar2, STATUS IN varchar2, EMPLOYEE_ID IN NUMBER)
IS
BEGIN
